...
from backend.services.crypto import SessionCrypto  # noqa: E402


class TestSessionCrypto(unittest.TestCase):
    def test_roundtrip_encrypt_decrypt(self):
        crypto = SessionCrypto("primary_secret")
    ...
    def test_rotation_returns_new_ciphertext(self):
        cookies = {"k": "v"}
        crypto_old = SessionCrypto("old_secret,new_secret")
        encrypted_old = crypto_old.encrypt_session(cookies)

        crypto_new = SessionCrypto("new_secret,old_secret")
